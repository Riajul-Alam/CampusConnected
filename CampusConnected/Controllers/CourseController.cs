...
namespace CampusConnected.Controllers
{
    public class CourseController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CourseName,CourseCode,Faculty")] Course course)
        {
            //if (ModelState.IsValid)
            //{
                _context.Add(course);
                await _context.SaveChangesAsync();
                TempData["insert_sucess"] = "Record Created Successfully!";
        ...
        public async Task<IActionResult> Edit(int id, [Bind("CId,CourseName,CourseCode,Faculty")] Course course)
        {
            ...
            if (ModelState.IsValid && TryValidateModel(course))
            {
                try
                {
                    _context.Update(course);
                    await _context.SaveChangesAsync();
                    TempData["update_sucess"] = "Record Updated Successfully!";
                }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            await _context.SaveChangesAsync();
            TempData["delete_sucess"] = "Record Deleted Successfully!";
            return RedirectToAction(nameof(Index));
        }
